...
class AuthState {
  ...
  const AuthState({
    this.user,
    this.isLoading = true, // Start as loading until we check session
    this.error,
...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  void _init() {
    ...
    _authSubscription = _authRepository.authStateChanges.listen((authState) async {
  ...
  Future<void> signUp({
    ...
    try {
      ...
      // Profile loaded by auth state listener
    } catch (e) {
      state = state.copyWith(
        isLoading: false,
        error: e.toString(),
